                ...
                <div class="card-body p-0" style="background: #fafafa">
                    <table class="table table-striped mb-0">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                <input required type="number" id="quantite" name="quantite" min="0" class="form-control @error("quantite") is-invalid @enderror" value="{{ old("quantite") }}">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                <input required type="number" id="prix" name="prix" min="0" class="form-control @error("prix") is-invalid @enderror" value="{{ old("prix") }}">
