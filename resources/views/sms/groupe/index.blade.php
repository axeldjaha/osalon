                        ...
                        <div class="card-body pt-0 table-responsive" style="background: #fafafa">
                            <table class="table table-hover table-striped" style="margin-top: 0 !important; margin-bottom: 0 !important;">
                                ...
                                @foreach($groupes as $groupe)
                                    <tr>
                                        <td><i class="fa fa-file-excel text-primary"></i></td>
                                        <td style="padding: .55rem">{{ $groupe->intitule }}</td>
                                        <td class="text-center">{{ number_format($groupe->contacts->count(), 0, ",", " ") }}</td>
                                        <td class="fit">
                                            <a href="{{ route("sms.fichier.show", $groupe) }}" class="btn btn-link btn-sm mr-sm-2">
                                                <i class="fa fa-file-alt"></i> Voir
                                            </a>

                                            <a href="{{ route("sms.fichier.exporter", $groupe) }}" class="btn btn-link btn-sm mr-sm-2">
